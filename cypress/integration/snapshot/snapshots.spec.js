...
describe('snapshot testing', () => {
  ...
  // Denne testen fungerer ikke på grunn av tilfeldige klassenavn som styled components lager. 
  // Styled components bruker ikke Math.random() så vi får ikke mocket det.
